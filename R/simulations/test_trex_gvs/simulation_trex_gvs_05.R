# ==============================================================================
# simulation_trex_gvs_05.R
# ==============================================================================
#
# T-Rex+GVS Monte Carlo simulations for the random-blocks DGP.
...
#
#  Part 3: MC simulation sweeping intra-block correlation rho.
...
#
# Single-run demo (Part 1) is in demo_trex_gvs_05.R.
#
# ==============================================================================
...
con_log <- file(file.path(log_dir, "simulation_trex_gvs_05.log"), open = "wt")
...
if (run_part_4) {
  trx_gvs_05_04 <- function() {
    ...
    cat(strrep("=", 70), "\n")
    cat("Random-Blocks GVS MC  |  Part 4: SNR x rho sweep\n")
...
cat("\nRandom-blocks GVS MC simulations complete.\n")
