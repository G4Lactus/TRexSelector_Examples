# =================================================================================
# simulation_trex_gvs_01.R
# =================================================================================
#
# T-Rex+GVS Monte Carlo simulations for the Hastie (Zou & Hastie 2005) DGP.
#
...
#
#  Part 3: MC simulation sweeping intra-group correlation rho.
...
#          Grid: SNR in
#          {0.2, 0.5, 1.0, 2.0, 5.0}, rho in {0.30, 0.50, 0.70, 0.90, 0.95, 0.99}.
#          Outputs TPP/FDP matrices for EN and IEN.
#
# Single-run demo (Part 1) is in demo_trex_gvs_01.R.
#
# =================================================================================
...
con_log <- file(file.path(log_dir, "simulation_trex_gvs_01.log"), open = "wt")
...
# ==============================================================================
# Compares EN vs IEN across SNR levels.
# Fixed: sd_x=sqrt(0.01) (rho~0.99), n=200, p=500, tFDR=0.1, K=20, 200 MC.
# SNR grid: {0.1, 0.2, 0.5, 1.0, 2.0, 5.0}.
# ==============================================================================

if (run_part_2) {
  trx_gvs_01_hastie_02 <- function() {

    snr_grid <- c(0.1, 0.2, 0.5, 1.0, 2.0, 5.0)

    .run_snr_sweep <- function(GVS_type) {
      cat(strrep("=", 70), "\n")
      cat("Hastie GVS MC \u2014 SNR sweep\n")
...
# ==============================================================================
# Sweeps intra-group correlation rho; sd_x derived as sqrt((1-rho)/rho).
# Fixed: SNR=2.0, n=200, p=500, tFDR=0.1, K=20, 200 MC.
# rho grid: {0.10, 0.20, 0.30, 0.50, 0.70, 0.80, 0.90, 0.95, 0.99}.
# ==============================================================================

if (run_part_3) {
  trx_gvs_01_hastie_03 <- function() {

    rho_grid <- c(0.10, 0.20, 0.30, 0.50, 0.70, 0.80, 0.90, 0.95, 0.99)

    .run_rho_sweep <- function(GVS_type) {
      cat(strrep("=", 70), "\n")
      cat("Hastie GVS MC \u2014 rho sweep\n")
...
# Part 4: 2D phase-transition sweep: SNR x rho
# ==============================================================================
# Jointly sweeps SNR and intra-group correlation rho.
# Outputs TPP/FDP matrices for both EN and IEN.
#
# Fixed: n=200, p=500, tFDR=0.1, K=20, 200 MC.
# snr_grid : {0.2, 0.5, 1.0, 2.0, 5.0}
# rho_grid : {0.30, 0.50, 0.70, 0.90, 0.95, 0.99}
# ==============================================================================

if (run_part_4) {
  trx_gvs_01_hastie_04 <- function() {
    ...
    cat(strrep("=", 70), "\n")
    cat("Hastie GVS MC  |  Part 4: SNR x rho sweep\n")
  ...
  trx_gvs_01_hastie_04()

}  # end Part 4
# ==============================================================================


cat("\nHastie GVS MC simulations complete.\n")
