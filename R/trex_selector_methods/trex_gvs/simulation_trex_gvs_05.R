...
# ==============================================================================
#
# T-Rex+GVS Monte Carlo simulations for the equi-correlated blocks DGP.
...
#          Fixed: rho=0.75, n=200, p=500, tFDR=0.1, K=20, 200 MC.
...
if (run_part_4) {
  trx_gvs_08_04 <- function() {
    ...
    cat(strrep("=", 70), "\n")
    cat("Equi-Blocks GVS MC  |  Part 4: SNR x rho sweep\n")
...
cat("\nEqui-blocks GVS MC simulations complete.\n")
