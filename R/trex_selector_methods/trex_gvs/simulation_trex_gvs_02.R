# ==============================================================================
# simulation_trex_gvs_02.R
# ==============================================================================
#
# T-Rex+GVS Monte Carlo simulations for the scattered-grouped DGP.
#
...
#
# Single-run demo (Part 1) is in demo_trex_gvs_02.R.
#
# ==============================================================================
    ...
    .run_snr_sweep <- function(GVS_type) {
      ...
      lapply(snr_grid, function(snr_val) {
        ...
        r <- .run_mc_scattered(
          ...
          snr        = snr_val,
          sd_x       = MC_BASE$sd_x,
          n_groups   = MC_BASE$n_groups,
          group_size = MC_BASE$group_size,
          tFDR       = MC_BASE$tFDR,
          K          = MC_BASE$K,
...
if (run_part_4) {
  trx_gvs_02_04 <- function() {
    ...
    cat(strrep("=", 70), "\n")
    cat("Scattered-Grouped GVS MC  |  Part 4: SNR x rho sweep\n")
...
cat("\nScattered-grouped GVS MC simulations complete.\n")
