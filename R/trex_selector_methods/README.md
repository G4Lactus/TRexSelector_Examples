...
| [trex_da/](trex_da/README.md) | Legacy — CRAN TRexSelector 1.0.0 | Dependency-Aware T-Rex over AR(1), equicorrelated, nearest-neighbor, block-diagonal, and heavy-tailed designs (demos 01–08) |
| [trex_gvs/](trex_gvs/README.md) | Legacy — CRAN TRexSelector 1.0.0 | Grouped Variable Selection T-Rex (EN vs IEN) over Hastie, scattered, mixed, negative-trap, equi-block, t-distributed, AR(1), and ARMA designs (demos 01–08 + simulation scripts) |
| [trex_spca/](trex_spca/README.md) | Legacy — CRAN TRexSelector 1.0.0 | T-Rex Sparse PCA MC evaluation plus four C++/R cross-check probe scripts |
| `trex_screening/` | — | Empty placeholder; the C++ screening demos are not mirrored in R yet |
...
The legacy suites additionally require the CRAN packages `TRexSelector`,
`plotly`, and use `parallel` for the MC loops.
