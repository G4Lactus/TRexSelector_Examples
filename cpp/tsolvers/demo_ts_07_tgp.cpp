...
// ============================================================================
/**
 * @file demo_ts_07_tgp.cpp
 *
 * @brief Demonstration of T-GP (Terminating Gradient Pursuit) solver.
 *
...
void demo_TGP_serialization() {
    ...
    // Print Demo Header
    cdiagnost::print_section_header("=== Demo 3: T-GP Serialization & Warm Start ===");
    ...
    tsolvers::TGP_Solver solver_ref(
        X_map,
        D_map,
        y_map,
        /*normalize=*/true,
    ...
    {
        tsolvers::TGP_Solver solver2 =
            tsolvers::TGP_Solver::load(filename, X_map, D_map);
...
void demo_memory_mapped(bool high_dim, bool rnd_coef, std::size_t T_stop) {
    ...
    const std::string X_file = "demo_tgp_X.bin";
    const std::string D_file = "demo_tgp_D.bin";
...
int main() {
    ...
    try {
        ...
        if (true) {
            demo_TGP_with_external_normalizer(/*high_dim=*/false, /*rnd_coef=*/false,
                                              /*T_stop=*/10);
            demo_TGP_with_external_normalizer(/*high_dim=*/true, /*rnd_coef=*/false,
                                              /*T_stop=*/10);
        }
