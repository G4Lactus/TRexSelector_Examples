...
void demo_TOMP_serialization() {
    ...
    // Print Demo Header
    cdiagnost::print_section_header("=== Demo 3: T-OMP Serialization & Warm Start ===");
    ...
    tsolvers::TOMP_Solver solver_ref(
        X_map,
        D_map,
        y_map,
        /*normalize=*/true,
    ...
    {
        tsolvers::TOMP_Solver solver2 =
            tsolvers::TOMP_Solver::load(filename, X_map, D_map);
...
int main() {
    ...
    try {
        ...
        if (true) {
            demo_TOMP_with_external_normalizer(/*high_dim=*/false, /*rnd_coef=*/false,
                                               /*T_stop=*/10);
            demo_TOMP_with_external_normalizer(/*high_dim=*/true, /*rnd_coef=*/false,
                                               /*T_stop=*/10);
        }
