// ============================================================================
// demo_ts_02_tlasso.cpp
// ============================================================================
/**
 * @file demo_ts_02_tlasso.cpp
 *
...
void demo_TLASSO_serialization() {
    ...
    tsolvers::TLASSO_Solver solver_ref(
        X_map,
        D_map,
        y_map,
        /*normalize=*/true,
    ...
    {
        tsolvers::TLASSO_Solver solver1(
            X_map,
            D_map,
            y_map,
            /*normalize=*/true,
    ...
    {
        tsolvers::TLASSO_Solver solver2 =
            tsolvers::TLASSO_Solver::load(filename, X_map, D_map);
...
void demo_memory_mapped(bool high_dim, bool rnd_coef, std::size_t T_stop) {
    ...
    const std::string X_file = "demo_tlasso_X.bin";
    const std::string D_file = "demo_tlasso_D.bin";
...
int main() {
    ...
    try {
        ...
        if (true) {
            demo_TLASSO_with_external_normalizer(/*high_dim=*/false, /*rnd_coef=*/false,
                                                 /*T_stop=*/10);
            demo_TLASSO_with_external_normalizer(/*high_dim=*/true, /*rnd_coef=*/false,
                                                 /*T_stop=*/10);
        }
